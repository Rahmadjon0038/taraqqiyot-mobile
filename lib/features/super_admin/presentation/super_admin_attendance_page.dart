        ...
        children: [
          ...
          FutureBuilder<List<AttendanceTeacher>>(
            ...
            builder: (context, snapshot) {
              ...
              // Faqat tanlangan kunda jadval bo'yicha darsi bor teacherlar
              final dayTeachers =
                  teachers
                      .where((teacher) => teacher.todayGroupsCount > 0)
                      .toList()
                    ..sort((a, b) {
                      // Davomati tugallanmaganlar tepada tursin
                      final ratioA =
              ...
              return Column(
                ...
                children: [
                  ...
                  if (dayTeachers.isNotEmpty) ...[
                    ...
                    for (final teacher in dayTeachers) ...[
                      _TeacherProgressCard(teacher: teacher),
                      const SizedBox(height: 8),
                    ],
                  ],
                ],
...
class _TeacherProgressCard extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final ratio = teacher.todayGroupsCount > 0
    ...
    final color = done ? const Color(0xFF16934F) : const Color(0xFFE9A23B);
